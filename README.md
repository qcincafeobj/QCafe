...
- or Download a release:
    ...
    | [version 2 build 1.8.6](https://github.com/qcincafeobj/QCafe/releases/tag/QCafe2) (latest) | Formal Specification and Verification of Quantum Circuits/Protocols in CafeOBJ (Master's Thesis at [JAIST](https://www.jaist.ac.jp/english/)) | **PHAM Quoc Vuong** <br> Main Supervisor: Senior Lecturer [Canh Minh Do](https://canhminhdo.github.io) <br> Second Supervisor: Professor [Kazuhiro Ogata](https://www.jaist.ac.jp/english/laboratory/cs/ogata.html) | <br>DOI/BibTeX are at release tag [QCafe2](https://github.com/qcincafeobj/QCafe/releases/tag/QCafe2). |
    | -[]() | - | - | - |
